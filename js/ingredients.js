                            ...
                            <tbody>
                                ${list.map(
                                    x => {
                                        ...
                                        const badge =
                                            !x.is_active
                                                ? '<span class="badge">ปิด</span>'
                                                : current <= 0
                                                    ? '<span class="badge out">หมด</span>'
                                                    : current <= min
                                                        ? '<span class="badge low">ต่ำ</span>'
...
function openAdjust(
    ...
    document
        ...
        .textContent =
            `${row.name} • คงเหลือ ${number(row.current_stock)} ${row.unit}`
