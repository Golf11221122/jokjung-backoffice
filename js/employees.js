...
function createIsolatedAuthClient() {
    /*
     * ใช้ Supabase project เดียวกัน แต่แยก auth storage ออกจาก
     * session ของ Admin ที่กำลังเปิดหน้า Employees อยู่
     */
    return createClient(
...
async function saveNewEmployee() {
    ...
    try {
        /*
         * 1) สร้าง Auth User ด้วย client แยก
         *    เพื่อไม่ให้ Admin หลุด session
         */
        const isolated =
        ...
        /*
         * 2) Admin ผูก user ใหม่เข้ากับสาขาและ role
         */
        const {
            data: onboardData,
            error: onboardError
        ...
        /*
         * 3) Manager ใช้ระบบ PIN เดิมของร้าน
         */
        if (
            role ===
            'manager'
        ...
        if (
            ...
            text =
                'สร้างบัญชีแล้ว แต่ตั้ง PIN Manager ไม่สำเร็จ กรุณาเปิดรายชื่อพนักงานแล้วตั้ง PIN อีกครั้ง'
        }
