...
begin
    ...
    if p_standard_yield_pct is not null and p_standard_yield_pct<=0 then
...
declare
    ...
    v_basis_qty numeric:=0;v_actual_yield numeric:=null;v_std_yield numeric:=null;
...
begin
    ...
    set basis_input_qty=nullif(v_basis_qty,0),actual_yield_pct=v_actual_yield,
